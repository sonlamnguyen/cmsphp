...
@section('content')
	...
	<div flex ng-controller="Area as vm">
		...
		<div ng-show="vm.model.vars.listItem | count">
			<div class="collapse-card" ng-repeat="item in vm.model.vars.listItem">
				...
				<div class="collapse-card__body">
					<!-- Body Text -->
					<div ng-repeat="device_type in vm.DeviceService.refs.types" ng-show="device_type.id|checkExistByDeviceType:vm.model.refs.devices:item.id">
						
						<md-list>
							<md-list-item class="list-border" ng-repeat="device in vm.model.refs.devices | filterBy:'area_id':item.id | filterBy:'device_type':device_type.id" ng-click="vm.toggleModal('changingForm', true, device.subnet_id + '.' + device.rtu_id)">
								<p>
									<b>{$ device_type.title $}. 
